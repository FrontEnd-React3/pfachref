    ...
    <div className="about">
      <div className="common">
        ...
        <p className="mainContent">
          ...
          themes, or subjects depending on their similarities in language,
          genre, or discourse. This is seen when an author borrows and
          transforms a prior text, or when you read one text and you reference
          another.
        </p>
